...
awk -F',' 'NR>1 {print $2, $1}' ${input_dir}/predictions_and_targets.csv | sort -nr | head -20 | awk '{print $2}' | sed 's/_interface_lframe.pdb/.pdb/' | xargs -I{} cp {} ../top_ternaries_results/
